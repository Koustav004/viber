...
const UseMessage = ({ content }: UserMessageProps) => {
    return (
        ...
        <div className={cn(
            ...
            <div className="flex items-center gap-2 pl-2 mb-2">
                <Image
                    ...
                    className="shrink-0"
                />
                <span className="text-sn font-medium">ViberV0</span>
                <span className="text-sn font-muted-foreground opacity-0 transition-opacity group-hover:opacity-100">
